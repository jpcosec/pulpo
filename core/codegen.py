    ...
    def generate(self) -> Path:
        ...
        for model_info in ModelRegistry.list_all():
            config = {
                ...
                "icon": model_info.ui_hints.get("icon", "📄"),
        ...
        print(f"✓ Generated {len(code.splitlines())} lines of TypeScript config")
        return output_file
...
class CopyAndGenerateFrontend(CodeGenerator):
    ...
    def generate(self) -> Path:
        ...
        print(f"  ✓ Copied template to {self.output_dir}")
        ...
        print(f"  ✓ Generated {len(generated_pages)} page files")
    ...
    def _generate_app_tsx(self):
        ...
        if not template_file.exists():
            print(f"  ⚠️  Warning: Template file {template_file} not found")
            return
    ...
    def _copy_ui_config(self):
        ...
        if source.exists():
            ...
            print(f"  ✓ Copied UI config to {dest}")
        else:
...
- ✅ React app with Refine.dev
- ✅ Auto-generated pages for all models
...
def compile_all(project_dir: Path | None = None):
    ...
    try:
        ...
        print(f"  ✓ Graphs generated in {docs_dir}/")
    except Exception as e:
